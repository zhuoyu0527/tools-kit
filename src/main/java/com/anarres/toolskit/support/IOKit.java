...
public class IOKit {
	...
	public static String read(InputStream in, String charset) throws IOException {
		...
		return CharsetKit.isBlank(charset) ? out.toString() : new String(out.toByteArray(), charset);
	}
	...
	public static String read(Reader reader) throws IOException{
		final StringBuilder builder = CharsetKit.builder();
	...
	public static ByteArrayInputStream toStream(String content, String charset) {
		...
		byte[] data = null;
		try {
			data = CharsetKit.isBlank(charset) ? content.getBytes() : content.getBytes(charset);
		} catch (UnsupportedEncodingException e) {
			throw new ToolBoxException(CharsetKit.format("Invalid charset [{}] !", charset), e);
		}
	...
	public static void write(OutputStream out, String charset, boolean isCloseOut, Object... contents) throws IOException {
		...
		try {
			...
			for (Object content : contents) {
				if(content != null) {
					osw.write(Convert.toStr(content, CharsetKit.EMPTY));
					osw.flush();
				}
			}
		} catch (Exception e) {
	...
	public static void echo(Object content, Object... param) {
		...
		System.out.println(CharsetKit.format(content.toString(), param));
	}
